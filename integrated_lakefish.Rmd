...
ISDMsetup$spatialBlock(k = 4, rows_cols = c(2,2), 
                       plot = TRUE, flat_top = TRUE)

ISDMsetupBias$spatialBlock(k = 4, rows_cols = c(2,2), 
                       plot = FALSE, flat_top = TRUE)

```

And then fit the models using `blockCV`:
