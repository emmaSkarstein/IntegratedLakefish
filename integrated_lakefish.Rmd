...
For the presence/absence survey data, we use a Bernoulli distribution, where the presence probability for species $j\in \{\textit{Salmo trutta, Perca fluvatilis, Esox lucius, Salvelinus alpinus}\}$ depends on some covariates $x(s)$, along with a spatial field $\xi_{j}(s)$:
